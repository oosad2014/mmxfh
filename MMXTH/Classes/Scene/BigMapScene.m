...
- (id)init {
    ...
    // 从Scene处理到Node的处理的跨越
    self.background = [CCNodeColor nodeWithColor:[CCColor blackColor]];
...
- (void)initScene {
    CCSprite *chinaMap = [CCSprite spriteWithImageNamed:@"中国.png"];
    ...
    for (NSString *key in chinaDic.allKeys ) {
        CCSprite *oneMap = [CCSprite spriteWithImageNamed:[@"" stringByAppendingFormat:@"%@.png", key]];
